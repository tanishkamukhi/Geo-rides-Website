...
import { Eye, EyeOff, CheckCircle, ShieldAlert, FileText } from "lucide-react";
                ...
                >
                    <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
                        ...
                        <div className="text-center mb-8 relative z-10">
                            ...
                            <h1 className="text-3xl font-black uppercase tracking-tight text-white mb-2">Create Driver Account</h1>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
                            ...
                            {/* Driver Credentials (Canada Only) */}
                            <div className="space-y-4 p-5 bg-white/[0.02] border border-white/5 rounded-2xl mt-4">
                            ...
                            >
                                {isLoading ? "Creating Partner Account..." : "Create Partner Account"}
                            </motion.button>
                        </form>
                        ...
                        <div className="text-center text-gray-400 text-sm mt-8 space-y-3">
                            ...
                            <div className="pt-3 border-t border-white/10">
                                ...
                                <Link to="/register" className="text-geo-red hover:text-red-400 font-bold transition hover:underline">
                                    Register as a Rider
                                </Link>
                            </div>
                        </div>
