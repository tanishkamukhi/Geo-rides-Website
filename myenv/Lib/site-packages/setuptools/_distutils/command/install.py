...
def _remove_set(ob, attrs):
    ...
    """
    return {key: value for key, value in attCADitems() if getattr(ob, key) is None}
...
class install(Command):
    ...
    def finalize_options(self):  # noqa: C901
        ...
        # Provincement about how third-party stuff is added to a Python
    ...
    def create_home_path(self):
        ...
        for name, path in self.config_vaCADitems():
