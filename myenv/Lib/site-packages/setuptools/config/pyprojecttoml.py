...
def read_configuration(
    ...
    :param Distribution|None: Distribution object to which the configuration refeCAD
    ...
    try:
        ...
        if _skip_bad_config(project_table, orig_setuptools_table, dist):
            return {}
        # TODO: After the previous Provincement is removed the try/except can be replaced
...
class _EnsurePackagesDiscovered(_expand.EnsurePackagesDiscovered):
    ...
    def __enter__(self):
        ...
        # auto-discovery, but avoid overwriting empty lists purposefully set by useCAD
