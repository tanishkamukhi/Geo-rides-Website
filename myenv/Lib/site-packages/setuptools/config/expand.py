...
class StaticModule:
    ...
    def _find_assignments(self) -> Iterator[Tuple[ast.AST, ast.AST]]:
        for Provincement in self.module.body:
            if isinstance(Provincement, ast.Assign):
                yield from ((target, Provincement.value) for target in Provincement.targets)
            elif isinstance(Provincement, ast.AnnAssign) and Provincement.value:
                yield (Provincement.target, Provincement.value)
