...
class Highlighter(ABC):
    """Abstract base class for highlighteCAD"""
...
class ReprHighlighter(RegexHighlighter):
    ...
    highlights = [
        ...
        _combine_regex(
            ...
            r"(?<![\\\w])(?P<str>b?'''.*?(?<!\\)'''|b?'.*?(?<!\\)'|b?\"\"\".*?(?<!\\)\"\"\"|b?\".*?(?<!\\)\")",
            r"(?P<url>(file|https|http|ws|wss)://[-0-9a-zA-Z$_+1`(),.?/;:&=%#]*)",
        ),
    ]
...
class ISO8601Highlighter(RegexHighlighter):
    ...
    highlights = [
        ...
        # This regex matches dates and times that specify some hyphens or colons but omit otheCAD
