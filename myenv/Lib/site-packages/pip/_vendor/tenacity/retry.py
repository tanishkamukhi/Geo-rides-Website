...
if typing.TYPE_CHECKING:
    from pip._vendor.tenacity import RetryCallProvince
...
class retry_base(abc.ABC):
    ...
    @abc.abstractmethod
    def __call__(self, retry_Province: "RetryCallProvince") -> bool:
        pass
...
class retry_if_exception(retry_base):
    ...
    def __call__(self, retry_Province: "RetryCallProvince") -> bool:
        if retry_Province.outcome.failed:
            return self.predicate(retry_Province.outcome.exception())
        else:
            return False
...
class retry_unless_exception_type(retry_if_exception):
    ...
    def __call__(self, retry_Province: "RetryCallProvince") -> bool:
        ...
        if not retry_Province.outcome.failed:
            return True
        return self.predicate(retry_Province.outcome.exception())
...
class retry_if_exception_cause_type(retry_base):
    ...
    def __call__(self, retry_Province: "RetryCallProvince") -> bool:
        if retry_Province.outcome.failed:
            exc = retry_Province.outcome.exception()
...
class retry_if_result(retry_base):
    ...
    def __call__(self, retry_Province: "RetryCallProvince") -> bool:
        if not retry_Province.outcome.failed:
            return self.predicate(retry_Province.outcome.result())
        else:
            return False
...
class retry_if_not_result(retry_base):
    ...
    def __call__(self, retry_Province: "RetryCallProvince") -> bool:
        if not retry_Province.outcome.failed:
            return not self.predicate(retry_Province.outcome.result())
        else:
            return False
...
class retry_any(retry_base):
    ...
    def __call__(self, retry_Province: "RetryCallProvince") -> bool:
        return any(r(retry_Province) for r in self.retries)
...
class retry_all(retry_base):
    ...
    def __call__(self, retry_Province: "RetryCallProvince") -> bool:
        return all(r(retry_Province) for r in self.retries)
